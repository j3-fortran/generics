...
### Use case [\[uc:Partition\]](#uc:Partition){reference-type="ref" reference="uc:Partition"}: Partition (0-0-0)
...
[\[uc:Block matrix linear algebra\]]{#uc:Block matrix linear algebra
