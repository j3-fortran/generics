...
module GenericBlockMatrixMultiply_mod
  ...
  type, abstract :: BlockA
   contains
     procedure(matrix_multiply), deferred :: matrix_multiply   ! BlockA .matmul. BlockB
  ...
  type, abstract :: BlockC
   contains
     procedure(plus), deferred :: plus !   c = a + t
     generic :: operator(+) => plus
     procedure(zero), deferred :: zero
     procedure(assign), deferred :: assign  ! c = c
  ...
  type :: BlockMatrix ! <BlockA,BlockB,BlockC,BlockT>
   ...
   contains
     procedure :: my_matmul
     generic :: operator(.matmul.) => my_matmul
